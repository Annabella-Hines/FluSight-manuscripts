...
df <- model_metadata %>% 
  dplyr::select(model_id, team_abbr, model_abbr, team_name, model_name, designated_model, methods, methods_long, ensemble_of_models) %>% 
...
write.csv(df, paste0("C:/Users/", Sys.info()["user"], "/Desktop/GitHub/FluSight-manuscripts/ED_Visits_2025_26/model_types.csv"), row.names = FALSE)
